...
|------|--------------------|----------------|--------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|---------------------------------------------------------|--------|
| TP01 | POST  | Carga          | 1. Criar filme<br>2. Repetir sob carga contínua                                                 | Cadastro bem-sucedido para todas as requisições        | 50 a 200 usuários simultâneos durante 4 minutos             | ✔️     |
| TP02 | POST | Concorrência   | 1. Criar filme<br>2.Repetir com múltiplas requisições simultâneas            | Cadastro bem-sucedido para todas as requisições      | 50 a 300 usuários simultâneos durante 3 minutos e 30 segundos             | ✔️     |
| TP03 | GET/{id} | Escalabilidade | 1. Criar filme<br>2. Buscar filmes por ID<br>3. Aumentar progressivamente o número de usuários                      | Busca bem-sucedida com aumento progressivo de carga | 50 a 500 usuários simultâneos durante 5 minutos             | ✔️     |
| TP04 | POST | Estresse       | 1. Criar filme<br>2. Aumentar a carga até o ponto de falha                                         | Cadastro bem-sucedido para todas as requisições                   | 50 a 300 usuários simultâneos durante 4 minutos             | ❌     |
| TP05 | PUT | Pico           | 1. Criar filme<br>2. Atualizar filme<br>3. Aplicar picos súbitos de carga                                            | Atualização bem-sucedida durante picos de carga     | 50 a 500 usuários simultâneos durante 30 segundos           | ✔️     |

## Rota: Tickets

| ID   | Verbo HTTP Testado | Tipo de Teste  | Passos                                                                                                                   | Resultado Esperado                                   | Configurações do Teste                                   | Status |
|------|--------------------|----------------|--------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|---------------------------------------------------------|--------|
| TP06 | POST | Carga          | 1. Criar filme<br>2. Criar ticket<br>3. Repetir sob carga contínua                                                   | Criação de ticket bem-sucedida para todas as requisições        | 50 a 200 usuários simultâneos durante 4 minutos              | ✔️     |
| TP07 | POST | Concorrência   | 1. Criar filme<br>2. Criar ticket<br>3. Repetir com múltiplas requisições simultâneas                                | Criação de ticket bem-sucedida para todas as requisições        | 50 a 300 usuários simultâneos durante  minutos e 40 segundos              | ✔️     |
| TP08 | GET/{id} | Escalabilidade | 1. Criar filme<br>2. Criar ticket<br>3. Buscar tickets por ID<br>4. Aumentar progressivamente o número de usuários                               | Busca de tickets bem-sucedida com aumento progressivo de carga | 50 a 500 usuários simultâneos durante 5 minutos              | ✔️     |
| TP09 | POST | Estresse       | 1. Criar filme<br>2. Criar ticket<br>3. Aumentar a carga até o ponto de falha                                        | Criação de ticket bem-sucedida para todas as requisições                   | 50 a 300 usuários simultâneos durante 4 minutos              | ❌     |
| TP10 | PUT | Pico           | 1. Criar filme<br>2. Criar ticket<br>3. Atualizar ticket<br>4. Aplicar picos súbitos de carga                                               | Atualização de ticket bem-sucedida durante picos de carga           | 50 a 500 usuários simultâneos durante 30 segundos            | ✔️     |

## Flow01

| ID   | Tipo de Teste  | Passos                                                                                                                   | Resultado Esperado                                   | Configurações do Teste                                   | Status |
|------|----------------|--------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|---------------------------------------------------------|--------|
| TP23 | Carga          | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Listar todos os tickets<br>5. Remover ticket<br>6. Remover filme<br>7. Repetir continuamente | Todas as etapas do fluxo são concluídas com sucesso | 50 a 200 usuários simultâneos durante 4 minutos               | ✔️     |
| TP24 | Concorrência   | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Listar todos os tickets<br>5. Remover ticket<br>6. Remover filme<br>7. Repetir continuamente | Todas as etapas do fluxo são concluídas com sucesso | 50 a 300 usuários simultâneos durante  minutos e 40 segundos | ✔️     |
| TP25 | Escalabilidade | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Listar todos os tickets<br>5. Remover ticket<br>6. Remover filme<br>7. Repetir continuamente | Todas as etapas do fluxo são concluídas com sucesso | 50 a 500 usuários simultâneos durante 5 minutos               | ✔️     |
| TP26 | Estresse       | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Listar todos os tickets<br>5. Remover ticket<br>6. Remover filme<br>7. Repetir continuamente | Identificação dos pontos de falha no fluxo          | 50 a 300 usuários simultâneos durante 4 minutos               | ✔️     |
| TP27 | Pico           | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Listar todos os tickets<br>5. Remover ticket<br>6. Remover filme<br>7. Repetir continuamente | Todas as etapas do fluxo são concluídas com sucesso durante os picos | 50 a 500 usuários simultâneos durante 30 segundos             | ✔️     |

## Flow02

| ID   | Tipo de Teste  | Passos                                                                                                                   | Resultado Esperado                                   | Configurações do Teste                                   | Status |
|------|----------------|--------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|---------------------------------------------------------|--------|
| TP28 | Carga          | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Remover ticket<br>5. Remover filme<br>6. Repetir continuamente | Todas as etapas do fluxo são concluídas com sucesso | 50 a 280 usuários simultâneos durante 4 minutos               | ❌     |
| TP29 | Concorrência   | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Remover ticket<br>5. Remover filme<br>6. Repetir continuamente | Todas as etapas do fluxo são concluídas com sucesso | 50 a 270 usuários simultâneos durante 3 minutos e 30 segundos | ❌     |
| TP30 | Escalabilidade | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Remover ticket<br>5. Remover filme<br>6. Repetir continuamente | Todas as etapas do fluxo são concluídas com sucesso | 50 a 300 usuários simultâneos durante 4 minutos               | ❌     |
| TP31 | Estresse       | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Remover ticket<br>5. Remover filme<br>6. Repetir continuamente | Identificação dos pontos de falha no fluxo          | 50 a 300 usuários simultâneos durante 4 minutos               | ❌     |
| TP32 | Pico           | 1. Criar filme<br>2. Listar todos os filmes<br>3. Criar ticket<br>4. Remover ticket<br>5. Remover filme<br>6. Repetir continuamente | Todas as etapas do fluxo são concluídas com sucesso durante os picos | 50 a 400 usuários simultâneos durante 30 segundos             | ❌     |
...
| TP05  | Concorrência                        | Stages: 50 a 300, Duração: 1 min e 40 sec |
| TP06  | Capacidade                          | Stages: 50 a 500, Duração: 3 min e 30 sec |
